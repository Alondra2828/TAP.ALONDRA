...
public class Practica66 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Practica66.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Practica66().setVisible(true);
            }
        });
    }
    ...
    private void guardarArchivo() {
        ...
        try {
            ...
            Logger.getLogger(Practica66.class.getName()).log(Level.SEVERE, null, ex);
        }
